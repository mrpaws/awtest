...
class WhenToCallInstallCompleteModel(object):
    ...
    def __init__(self, use_additional_criteria=None, identify_application_by=None, criteria_list=None, custom_script=None, _configuration=None):  # noqa: E501
        """WhenToCallInstallCompleteModel - a model defined in Swagger"""  # noqa: E501
    ...
    def use_additional_criteria(self):
        """Gets the use_additional_criteria of this WhenToCallInstallCompleteModel.  # noqa: E501

        Gets or sets a value indicating whether value indicating whether additional criteria has to be used or not.  # noqa: E501

        :return: The use_additional_criteria of this WhenToCallInstallCompleteModel.  # noqa: E501
        :rtype: bool
        """
    ...
    def use_additional_criteria(self, use_additional_criteria):
        """Sets the use_additional_criteria of this WhenToCallInstallCompleteModel.

        Gets or sets a value indicating whether value indicating whether additional criteria has to be used or not.  # noqa: E501

        :param use_additional_criteria: The use_additional_criteria of this WhenToCallInstallCompleteModel.  # noqa: E501
        :type: bool
        """
    ...
    def identify_application_by(self):
        """Gets the identify_application_by of this WhenToCallInstallCompleteModel.  # noqa: E501
        ...
        :return: The identify_application_by of this WhenToCallInstallCompleteModel.  # noqa: E501
        :rtype: str
        """
    ...
    def identify_application_by(self, identify_application_by):
        """Sets the identify_application_by of this WhenToCallInstallCompleteModel.

        Gets or sets the way by which an application can be identified (Supported Values: DefiningCriteria, UsingCustomScript).  # noqa: E501

        :param identify_application_by: The identify_application_by of this WhenToCallInstallCompleteModel.  # noqa: E501
        :type: str
        """
    ...
    def criteria_list(self):
        """Gets the criteria_list of this WhenToCallInstallCompleteModel.  # noqa: E501

        Gets or sets the criteria configured to identify application.  # noqa: E501

        :return: The criteria_list of this WhenToCallInstallCompleteModel.  # noqa: E501
    ...
    def criteria_list(self, criteria_list):
        """Sets the criteria_list of this WhenToCallInstallCompleteModel.

        Gets or sets the criteria configured to identify application.  # noqa: E501

        :param criteria_list: The criteria_list of this WhenToCallInstallCompleteModel.  # noqa: E501
    ...
    def custom_script(self):
        """Gets the custom_script of this WhenToCallInstallCompleteModel.  # noqa: E501

        Gets or sets the custom script configured to identify application.  # noqa: E501

        :return: The custom_script of this WhenToCallInstallCompleteModel.  # noqa: E501
    ...
    def custom_script(self, custom_script):
        """Sets the custom_script of this WhenToCallInstallCompleteModel.

        Gets or sets the custom script configured to identify application.  # noqa: E501

        :param custom_script: The custom_script of this WhenToCallInstallCompleteModel.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WhenToCallInstallCompleteModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WhenToCallInstallCompleteModel):
            return False
