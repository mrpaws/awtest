...
class HowToInstallV1Model(object):
    ...
    attribute_map = {
        ...
        'install_timeout_in_minutes': 'install_timeout_in_minutes',
    ...
    def __init__(self, install_context=None, install_command=None, admin_privileges=None, device_restart=None, retry_count=None, retry_interval_in_minutes=None, install_timeout_in_minutes=None, installer_reboot_exit_code=None, installer_success_exit_code=None, restart_deadline_in_days=None, _configuration=None):  # noqa: E501
        """HowToInstallV1Model - a model defined in Swagger"""  # noqa: E501
    ...
    def install_context(self):
        """Gets the install_context of this HowToInstallV1Model.  # noqa: E501

        Gets or sets the install context (Supported values: Device = 1, User = 2) where the package has to be installed.  # noqa: E501

        :return: The install_context of this HowToInstallV1Model.  # noqa: E501
        :rtype: int
        """
    ...
    def install_context(self, install_context):
        """Sets the install_context of this HowToInstallV1Model.

        Gets or sets the install context (Supported values: Device = 1, User = 2) where the package has to be installed.  # noqa: E501

        :param install_context: The install_context of this HowToInstallV1Model.  # noqa: E501
        :type: int
        """
    ...
    def install_command(self):
        """Gets the install_command of this HowToInstallV1Model.  # noqa: E501

        Gets or sets the install command to install a package using the command line ex: \"/quiet\".  # noqa: E501

        :return: The install_command of this HowToInstallV1Model.  # noqa: E501
        :rtype: str
        """
    ...
    def install_command(self, install_command):
        """Sets the install_command of this HowToInstallV1Model.

        Gets or sets the install command to install a package using the command line ex: \"/quiet\".  # noqa: E501

        :param install_command: The install_command of this HowToInstallV1Model.  # noqa: E501
        :type: str
        """
    ...
    def admin_privileges(self):
        """Gets the admin_privileges of this HowToInstallV1Model.  # noqa: E501

        Gets or sets a value indicating whether admin privileges are needed for the installation of a package.  # noqa: E501

        :return: The admin_privileges of this HowToInstallV1Model.  # noqa: E501
        :rtype: bool
        """
    ...
    def admin_privileges(self, admin_privileges):
        """Sets the admin_privileges of this HowToInstallV1Model.

        Gets or sets a value indicating whether admin privileges are needed for the installation of a package.  # noqa: E501

        :param admin_privileges: The admin_privileges of this HowToInstallV1Model.  # noqa: E501
        :type: bool
        """
    ...
    def device_restart(self):
        """Gets the device_restart of this HowToInstallV1Model.  # noqa: E501

        Gets or sets the device restart option. Supported values: DoNotRestart = 1, ForceRestart = 2, RestartIfNeeded = 3.  # noqa: E501

        :return: The device_restart of this HowToInstallV1Model.  # noqa: E501
        :rtype: int
        """
    ...
    def device_restart(self, device_restart):
        """Sets the device_restart of this HowToInstallV1Model.

        Gets or sets the device restart option. Supported values: DoNotRestart = 1, ForceRestart = 2, RestartIfNeeded = 3.  # noqa: E501

        :param device_restart: The device_restart of this HowToInstallV1Model.  # noqa: E501
        :type: int
        """
        allowed_values = [0, 1, 2, 3]  # noqa: E501
        if (self._configuration.client_side_validation and
                device_restart not in allowed_values):
            raise ValueError(
                "Invalid value for `device_restart` ({0}), must be one of {1}"  # noqa: E501
                .format(device_restart, allowed_values)
            )
    ...
    def retry_count(self):
        """Gets the retry_count of this HowToInstallV1Model.  # noqa: E501

        Gets or sets the number of times the package installation operation has to be retried. Valid range 0 - 10.  # noqa: E501

        :return: The retry_count of this HowToInstallV1Model.  # noqa: E501
        :rtype: int
        """
    ...
    def retry_count(self, retry_count):
        """Sets the retry_count of this HowToInstallV1Model.

        Gets or sets the number of times the package installation operation has to be retried. Valid range 0 - 10.  # noqa: E501

        :param retry_count: The retry_count of this HowToInstallV1Model.  # noqa: E501
        :type: int
        """
    ...
    def retry_interval_in_minutes(self):
        """Gets the retry_interval_in_minutes of this HowToInstallV1Model.  # noqa: E501

        Gets or sets the amount of time in minutes between retry operations.  Valid range 0 - 10.  # noqa: E501

        :return: The retry_interval_in_minutes of this HowToInstallV1Model.  # noqa: E501
        :rtype: int
        """
    ...
    def retry_interval_in_minutes(self, retry_interval_in_minutes):
        """Sets the retry_interval_in_minutes of this HowToInstallV1Model.

        Gets or sets the amount of time in minutes between retry operations.  Valid range 0 - 10.  # noqa: E501

        :param retry_interval_in_minutes: The retry_interval_in_minutes of this HowToInstallV1Model.  # noqa: E501
        :type: int
        """
    ...
    def install_timeout_in_minutes(self):
        """Gets the install_timeout_in_minutes of this HowToInstallV1Model.  # noqa: E501
        ...
        :return: The install_timeout_in_minutes of this HowToInstallV1Model.  # noqa: E501
        :rtype: int
        """
    ...
    def install_timeout_in_minutes(self, install_timeout_in_minutes):
        """Sets the install_timeout_in_minutes of this HowToInstallV1Model.

        Gets or sets the amount of time in minutes that the installation process can run before the installer considers the installation may have failed.  Valid range 0 - 60.  # noqa: E501

        :param install_timeout_in_minutes: The install_timeout_in_minutes of this HowToInstallV1Model.  # noqa: E501
        :type: int
        """
    ...
    def installer_reboot_exit_code(self):
        """Gets the installer_reboot_exit_code of this HowToInstallV1Model.  # noqa: E501

        Gets or sets the success exit code.  # noqa: E501

        :return: The installer_reboot_exit_code of this HowToInstallV1Model.  # noqa: E501
        :rtype: str
        """
    ...
    def installer_reboot_exit_code(self, installer_reboot_exit_code):
        """Sets the installer_reboot_exit_code of this HowToInstallV1Model.

        Gets or sets the success exit code.  # noqa: E501

        :param installer_reboot_exit_code: The installer_reboot_exit_code of this HowToInstallV1Model.  # noqa: E501
        :type: str
        """
    ...
    def installer_success_exit_code(self):
        """Gets the installer_success_exit_code of this HowToInstallV1Model.  # noqa: E501

        Gets or sets the success exit code.  # noqa: E501

        :return: The installer_success_exit_code of this HowToInstallV1Model.  # noqa: E501
        :rtype: str
        """
    ...
    def installer_success_exit_code(self, installer_success_exit_code):
        """Sets the installer_success_exit_code of this HowToInstallV1Model.

        Gets or sets the success exit code.  # noqa: E501

        :param installer_success_exit_code: The installer_success_exit_code of this HowToInstallV1Model.  # noqa: E501
        :type: str
        """
    ...
    def restart_deadline_in_days(self):
        """Gets the restart_deadline_in_days of this HowToInstallV1Model.  # noqa: E501

        Gets or sets the number of days within which device should reboot.  # noqa: E501

        :return: The restart_deadline_in_days of this HowToInstallV1Model.  # noqa: E501
        :rtype: int
        """
    ...
    def restart_deadline_in_days(self, restart_deadline_in_days):
        """Sets the restart_deadline_in_days of this HowToInstallV1Model.

        Gets or sets the number of days within which device should reboot.  # noqa: E501

        :param restart_deadline_in_days: The restart_deadline_in_days of this HowToInstallV1Model.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HowToInstallV1Model, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HowToInstallV1Model):
            return False
