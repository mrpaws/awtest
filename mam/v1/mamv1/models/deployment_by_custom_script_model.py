...
class DeploymentByCustomScriptModel(object):
    ...
    def __init__(self, script_type=None, command_to_run_the_script=None, custom_script_file_blod_id=None, success_exit_code=None, _configuration=None):  # noqa: E501
        """DeploymentByCustomScriptModel - a model defined in Swagger"""  # noqa: E501
    ...
    def script_type(self):
        """Gets the script_type of this DeploymentByCustomScriptModel.  # noqa: E501

        Gets or sets script Type (JScript, PowerShell, VBScript).  # noqa: E501

        :return: The script_type of this DeploymentByCustomScriptModel.  # noqa: E501
        :rtype: str
        """
    ...
    def script_type(self, script_type):
        """Sets the script_type of this DeploymentByCustomScriptModel.

        Gets or sets script Type (JScript, PowerShell, VBScript).  # noqa: E501

        :param script_type: The script_type of this DeploymentByCustomScriptModel.  # noqa: E501
        :type: str
        """
    ...
    def command_to_run_the_script(self):
        """Gets the command_to_run_the_script of this DeploymentByCustomScriptModel.  # noqa: E501

        Gets or sets command to run the script.  # noqa: E501

        :return: The command_to_run_the_script of this DeploymentByCustomScriptModel.  # noqa: E501
        :rtype: str
        """
    ...
    def command_to_run_the_script(self, command_to_run_the_script):
        """Sets the command_to_run_the_script of this DeploymentByCustomScriptModel.

        Gets or sets command to run the script.  # noqa: E501

        :param command_to_run_the_script: The command_to_run_the_script of this DeploymentByCustomScriptModel.  # noqa: E501
        :type: str
        """
    ...
    def custom_script_file_blod_id(self):
        """Gets the custom_script_file_blod_id of this DeploymentByCustomScriptModel.  # noqa: E501
        ...
        :return: The custom_script_file_blod_id of this DeploymentByCustomScriptModel.  # noqa: E501
        :rtype: int
        """
    ...
    def custom_script_file_blod_id(self, custom_script_file_blod_id):
        """Sets the custom_script_file_blod_id of this DeploymentByCustomScriptModel.

        Gets or sets the BlobId of the script file associated.  Supported file types : js, jse, ps1, ps1xml, psc1, psd1, psm1, pssc, cdxml, vbs, vbe, wsf, wsc.  # noqa: E501

        :param custom_script_file_blod_id: The custom_script_file_blod_id of this DeploymentByCustomScriptModel.  # noqa: E501
        :type: int
        """
    ...
    def success_exit_code(self):
        """Gets the success_exit_code of this DeploymentByCustomScriptModel.  # noqa: E501

        Gets or sets the success exit code.  # noqa: E501

        :return: The success_exit_code of this DeploymentByCustomScriptModel.  # noqa: E501
        :rtype: int
        """
    ...
    def success_exit_code(self, success_exit_code):
        """Sets the success_exit_code of this DeploymentByCustomScriptModel.

        Gets or sets the success exit code.  # noqa: E501

        :param success_exit_code: The success_exit_code of this DeploymentByCustomScriptModel.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeploymentByCustomScriptModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeploymentByCustomScriptModel):
            return False
