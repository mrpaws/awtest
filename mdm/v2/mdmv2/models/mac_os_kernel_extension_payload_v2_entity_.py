...
class MacOsKernelExtensionPayloadV2Entity_(object):
    ...
    def __init__(self, allow_user_overrides=None, allowed_team_identifiers=None, allowed_kernel_extensions=None, _configuration=None):  # noqa: E501
        """MacOsKernelExtensionPayloadV2Entity_ - a model defined in Swagger"""  # noqa: E501
    ...
    def allow_user_overrides(self):
        """Gets the allow_user_overrides of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501
        ...
        :return: The allow_user_overrides of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_user_overrides(self, allow_user_overrides):
        """Sets the allow_user_overrides of this MacOsKernelExtensionPayloadV2Entity_.

        Gets or sets a value indicating whether indicates whether users are allowed to approve additional kernel extensions.  # noqa: E501

        :param allow_user_overrides: The allow_user_overrides of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501
        :type: bool
        """
    ...
    def allowed_team_identifiers(self):
        """Gets the allowed_team_identifiers of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501

        Gets or sets team identifiers for which all validly signed kernel extensions will be allowed to load.  # noqa: E501

        :return: The allowed_team_identifiers of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed_team_identifiers(self, allowed_team_identifiers):
        """Sets the allowed_team_identifiers of this MacOsKernelExtensionPayloadV2Entity_.

        Gets or sets team identifiers for which all validly signed kernel extensions will be allowed to load.  # noqa: E501

        :param allowed_team_identifiers: The allowed_team_identifiers of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501
        :type: list[str]
        """
    ...
    def allowed_kernel_extensions(self):
        """Gets the allowed_kernel_extensions of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501

        Gets or sets set of kernel extensions that will always be allowed to load on the machine.  # noqa: E501

        :return: The allowed_kernel_extensions of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501
    ...
    def allowed_kernel_extensions(self, allowed_kernel_extensions):
        """Sets the allowed_kernel_extensions of this MacOsKernelExtensionPayloadV2Entity_.

        Gets or sets set of kernel extensions that will always be allowed to load on the machine.  # noqa: E501

        :param allowed_kernel_extensions: The allowed_kernel_extensions of this MacOsKernelExtensionPayloadV2Entity_.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MacOsKernelExtensionPayloadV2Entity_, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MacOsKernelExtensionPayloadV2Entity_):
            return False
