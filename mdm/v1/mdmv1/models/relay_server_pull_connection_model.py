...
class RelayServerPullConnectionModel(object):
    ...
    attribute_map = {
        ...
        'max_pull_connections': 'MaxPullConnections',
        'max_push_connections': 'MaxPushConnections',
        'report_status_batch_size': 'ReportStatusBatchSize',
        'pull_phrase': 'PullPhrase'
    }

    def __init__(self, pull_local_directory=None, pull_discovery_text=None, pull_frequency=None, max_pull_connections=None, max_push_connections=None, report_status_batch_size=None, pull_phrase=None, _configuration=None):  # noqa: E501
        """RelayServerPullConnectionModel - a model defined in Swagger"""  # noqa: E501
        ...
        self._max_pull_connections = None
        ...
        if max_pull_connections is not None:
            self.max_pull_connections = max_pull_connections
    ...
    def pull_local_directory(self):
        """Gets the pull_local_directory of this RelayServerPullConnectionModel.  # noqa: E501

        Gets or sets the path of local directory to which the files will get copied.  # noqa: E501

        :return: The pull_local_directory of this RelayServerPullConnectionModel.  # noqa: E501
        :rtype: str
        """
    ...
    def pull_local_directory(self, pull_local_directory):
        """Sets the pull_local_directory of this RelayServerPullConnectionModel.

        Gets or sets the path of local directory to which the files will get copied.  # noqa: E501

        :param pull_local_directory: The pull_local_directory of this RelayServerPullConnectionModel.  # noqa: E501
        :type: str
        """
    ...
    def pull_discovery_text(self):
        """Gets the pull_discovery_text of this RelayServerPullConnectionModel.  # noqa: E501

        Gets or sets pullDiscoveryText - the text would be how the AW server will recognize the pull service.  # noqa: E501

        :return: The pull_discovery_text of this RelayServerPullConnectionModel.  # noqa: E501
        :rtype: str
        """
    ...
    def pull_discovery_text(self, pull_discovery_text):
        """Sets the pull_discovery_text of this RelayServerPullConnectionModel.

        Gets or sets pullDiscoveryText - the text would be how the AW server will recognize the pull service.  # noqa: E501

        :param pull_discovery_text: The pull_discovery_text of this RelayServerPullConnectionModel.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def pull_frequency(self):
        """Gets the pull_frequency of this RelayServerPullConnectionModel.  # noqa: E501

        Gets or sets the PullFrequency - How often during the time Window relay server should check-in.  # noqa: E501

        :return: The pull_frequency of this RelayServerPullConnectionModel.  # noqa: E501
        :rtype: int
        """
    ...
    def pull_frequency(self, pull_frequency):
        """Sets the pull_frequency of this RelayServerPullConnectionModel.

        Gets or sets the PullFrequency - How often during the time Window relay server should check-in.  # noqa: E501

        :param pull_frequency: The pull_frequency of this RelayServerPullConnectionModel.  # noqa: E501
        :type: int
        """
    ...
    @property
    def max_pull_connections(self):
        """Gets the max_pull_connections of this RelayServerPullConnectionModel.  # noqa: E501

        Gets or sets the MaxPullConnections - Number of connections between content pull and cloud relay server.  # noqa: E501

        :return: The max_pull_connections of this RelayServerPullConnectionModel.  # noqa: E501
        :rtype: int
        """
        return self._max_pull_connections

    @max_pull_connections.setter
    def max_pull_connections(self, max_pull_connections):
        """Sets the max_pull_connections of this RelayServerPullConnectionModel.

        Gets or sets the MaxPullConnections - Number of connections between content pull and cloud relay server.  # noqa: E501

        :param max_pull_connections: The max_pull_connections of this RelayServerPullConnectionModel.  # noqa: E501
        :type: int
        """

        self._max_pull_connections = max_pull_connections

    @property
    def max_push_connections(self):
        """Gets the max_push_connections of this RelayServerPullConnectionModel.  # noqa: E501

        Gets or sets the MaxPushConnections - Number of connections between Cloud relay and push relay servers.  # noqa: E501

        :return: The max_push_connections of this RelayServerPullConnectionModel.  # noqa: E501
        :rtype: int
        """
    ...
    def max_push_connections(self, max_push_connections):
        """Sets the max_push_connections of this RelayServerPullConnectionModel.

        Gets or sets the MaxPushConnections - Number of connections between Cloud relay and push relay servers.  # noqa: E501

        :param max_push_connections: The max_push_connections of this RelayServerPullConnectionModel.  # noqa: E501
        :type: int
        """
    ...
    def report_status_batch_size(self):
        """Gets the report_status_batch_size of this RelayServerPullConnectionModel.  # noqa: E501
        ...
        :return: The report_status_batch_size of this RelayServerPullConnectionModel.  # noqa: E501
        :rtype: int
        """
    ...
    def report_status_batch_size(self, report_status_batch_size):
        """Sets the report_status_batch_size of this RelayServerPullConnectionModel.

        Gets or sets the ReportStatusBatchSize - Number of relay server status in a batch to be reported by cloud relay to content pull.  # noqa: E501

        :param report_status_batch_size: The report_status_batch_size of this RelayServerPullConnectionModel.  # noqa: E501
        :type: int
        """
    ...
    def pull_phrase(self):
        """Gets the pull_phrase of this RelayServerPullConnectionModel.  # noqa: E501

        Gets or sets the pull phrase.  # noqa: E501

        :return: The pull_phrase of this RelayServerPullConnectionModel.  # noqa: E501
        :rtype: str
        """
    ...
    def pull_phrase(self, pull_phrase):
        """Sets the pull_phrase of this RelayServerPullConnectionModel.

        Gets or sets the pull phrase.  # noqa: E501

        :param pull_phrase: The pull_phrase of this RelayServerPullConnectionModel.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RelayServerPullConnectionModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RelayServerPullConnectionModel):
            return False
