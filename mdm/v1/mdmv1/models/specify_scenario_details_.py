...
class SpecifyScenarioDetails_(object):
    ...
    def __init__(self, file_to_be_tested=None, test_type=None, remove_file_after_test=None, _configuration=None):  # noqa: E501
        """SpecifyScenarioDetails_ - a model defined in Swagger"""  # noqa: E501
    ...
    def file_to_be_tested(self):
        """Gets the file_to_be_tested of this SpecifyScenarioDetails_.  # noqa: E501

        Gets or sets full path and name of test file.  # noqa: E501

        :return: The file_to_be_tested of this SpecifyScenarioDetails_.  # noqa: E501
        :rtype: str
        """
    ...
    def file_to_be_tested(self, file_to_be_tested):
        """Sets the file_to_be_tested of this SpecifyScenarioDetails_.

        Gets or sets full path and name of test file.  # noqa: E501

        :param file_to_be_tested: The file_to_be_tested of this SpecifyScenarioDetails_.  # noqa: E501
        :type: str
        """
    ...
    @property
    def test_type(self):
        """Gets the test_type of this SpecifyScenarioDetails_.  # noqa: E501
        ...
        :return: The test_type of this SpecifyScenarioDetails_.  # noqa: E501
        :rtype: str
        """
    ...
    def test_type(self, test_type):
        """Sets the test_type of this SpecifyScenarioDetails_.

        Gets or sets type of test file to be run on the device.The two scenarios are:  File Exists - A designated file on the device must exist in order to evaluate to TRUE.  File Does Not Exist - If the specified file does not exist on the device, the condition will evaluate to TRUE.  # noqa: E501

        :param test_type: The test_type of this SpecifyScenarioDetails_.  # noqa: E501
        :type: str
        """
    ...
    def remove_file_after_test(self):
        """Gets the remove_file_after_test of this SpecifyScenarioDetails_.  # noqa: E501

        Gets or sets whether to remove the File, once the condition evaluates to TRUE.  # noqa: E501

        :return: The remove_file_after_test of this SpecifyScenarioDetails_.  # noqa: E501
        :rtype: str
        """
    ...
    def remove_file_after_test(self, remove_file_after_test):
        """Sets the remove_file_after_test of this SpecifyScenarioDetails_.

        Gets or sets whether to remove the File, once the condition evaluates to TRUE.  # noqa: E501

        :param remove_file_after_test: The remove_file_after_test of this SpecifyScenarioDetails_.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SpecifyScenarioDetails_, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpecifyScenarioDetails_):
            return False
