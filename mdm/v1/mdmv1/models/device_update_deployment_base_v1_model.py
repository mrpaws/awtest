...
class DeviceUpdateDeploymentBaseV1Model(object):
    ...
    def __init__(self, name=None, deployment_start_time=None, deployment_type=None, smart_group_uuids=None, notifications=None, _configuration=None):  # noqa: E501
        """DeviceUpdateDeploymentBaseV1Model - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501

        Gets or sets the name of the deployment.  # noqa: E501

        :return: The name of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DeviceUpdateDeploymentBaseV1Model.

        Gets or sets the name of the deployment.  # noqa: E501

        :param name: The name of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
        :type: str
        """
    ...
    def deployment_start_time(self):
        """Gets the deployment_start_time of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501

        Gets or sets the deployment start time.  # noqa: E501

        :return: The deployment_start_time of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
        :rtype: datetime
        """
    ...
    def deployment_start_time(self, deployment_start_time):
        """Sets the deployment_start_time of this DeviceUpdateDeploymentBaseV1Model.

        Gets or sets the deployment start time.  # noqa: E501

        :param deployment_start_time: The deployment_start_time of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
        :type: datetime
        """
    ...
    def deployment_type(self):
        """Gets the deployment_type of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501

        Gets or sets the deployment type. Possible Values [DOWNLOAD_AND_INSTALL, DOWNLOAD_ONLY, INSTALL_ONLY].  # noqa: E501

        :return: The deployment_type of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
        :rtype: str
        """
    ...
    def deployment_type(self, deployment_type):
        """Sets the deployment_type of this DeviceUpdateDeploymentBaseV1Model.

        Gets or sets the deployment type. Possible Values [DOWNLOAD_AND_INSTALL, DOWNLOAD_ONLY, INSTALL_ONLY].  # noqa: E501

        :param deployment_type: The deployment_type of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
        :type: str
        """
    ...
    def smart_group_uuids(self):
        """Gets the smart_group_uuids of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501

        Gets or sets the list of smart group UUID where update needs to be deployed.  # noqa: E501

        :return: The smart_group_uuids of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def smart_group_uuids(self, smart_group_uuids):
        """Sets the smart_group_uuids of this DeviceUpdateDeploymentBaseV1Model.

        Gets or sets the list of smart group UUID where update needs to be deployed.  # noqa: E501

        :param smart_group_uuids: The smart_group_uuids of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
        :type: list[str]
        """
    ...
    def notifications(self):
        """Gets the notifications of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501

        Gets or sets the list of notification preferences for the deployment.  # noqa: E501

        :return: The notifications of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
    ...
    def notifications(self, notifications):
        """Sets the notifications of this DeviceUpdateDeploymentBaseV1Model.

        Gets or sets the list of notification preferences for the deployment.  # noqa: E501

        :param notifications: The notifications of this DeviceUpdateDeploymentBaseV1Model.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeviceUpdateDeploymentBaseV1Model, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceUpdateDeploymentBaseV1Model):
            return False
