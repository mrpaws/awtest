...
class MacOsSystemExtensionsPayloadV2Model_(object):
    ...
    def __init__(self, allow_user_overrides=None, allowed_system_extension_types=None, allowed_system_extensions=None, _configuration=None):  # noqa: E501
        """MacOsSystemExtensionsPayloadV2Model_ - a model defined in Swagger"""  # noqa: E501
    ...
    def allow_user_overrides(self):
        """Gets the allow_user_overrides of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501

        Gets or sets a value indicating whether if false, restricts users from approving additional system extensions.  # noqa: E501

        :return: The allow_user_overrides of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_user_overrides(self, allow_user_overrides):
        """Sets the allow_user_overrides of this MacOsSystemExtensionsPayloadV2Model_.

        Gets or sets a value indicating whether if false, restricts users from approving additional system extensions.  # noqa: E501

        :param allow_user_overrides: The allow_user_overrides of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501
        :type: bool
        """
    ...
    def allowed_system_extension_types(self):
        """Gets the allowed_system_extension_types of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501
        ...
        :return: The allowed_system_extension_types of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501
    ...
    def allowed_system_extension_types(self, allowed_system_extension_types):
        """Sets the allowed_system_extension_types of this MacOsSystemExtensionsPayloadV2Model_.

        Gets or sets includes a list of team identifiers with types of system extensions allowed or not allowed.  Team identifier Value \"*\" indicates the global team identifier.  # noqa: E501

        :param allowed_system_extension_types: The allowed_system_extension_types of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501
    ...
    def allowed_system_extensions(self):
        """Gets the allowed_system_extensions of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501
        ...
        :return: The allowed_system_extensions of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501
    ...
    def allowed_system_extensions(self, allowed_system_extensions):
        """Sets the allowed_system_extensions of this MacOsSystemExtensionsPayloadV2Model_.

        Gets or sets includes a list of team identifier and bundle identifier pairs defining the system extension to be installed.  Either Identifier is optional, but both can be included.  # noqa: E501

        :param allowed_system_extensions: The allowed_system_extensions of this MacOsSystemExtensionsPayloadV2Model_.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MacOsSystemExtensionsPayloadV2Model_, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MacOsSystemExtensionsPayloadV2Model_):
            return False
