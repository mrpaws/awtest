...
------------ | ------------- | ------------- | -------------
**shared_mdm_profile_data_id** | **int** | Shared MDM profile data ID. | [optional] 
**dep_authentication_id** | **int** | DEP authentication ID. | [optional] 
...
**hdn_token_id** | **int** | The hdn token ID. | [optional] 
...
**enrollment_username** | **str** | Enrollment username. | [optional] 
