...
class AppFilesOptionsModel(object):
    ...
    def __init__(self, app_dependencies_list=None, app_transforms_list=None, app_patches_list=None, application_un_install_process=None, _configuration=None):  # noqa: E501
        """AppFilesOptionsModel - a model defined in Swagger"""  # noqa: E501
    ...
    def app_dependencies_list(self):
        """Gets the app_dependencies_list of this AppFilesOptionsModel.  # noqa: E501

        Gets or sets list of application dependency Ids.  # noqa: E501

        :return: The app_dependencies_list of this AppFilesOptionsModel.  # noqa: E501
    ...
    def app_dependencies_list(self, app_dependencies_list):
        """Sets the app_dependencies_list of this AppFilesOptionsModel.

        Gets or sets list of application dependency Ids.  # noqa: E501

        :param app_dependencies_list: The app_dependencies_list of this AppFilesOptionsModel.  # noqa: E501
    ...
    def app_transforms_list(self):
        """Gets the app_transforms_list of this AppFilesOptionsModel.  # noqa: E501

        Gets or sets list of uploaded transform files.  # noqa: E501

        :return: The app_transforms_list of this AppFilesOptionsModel.  # noqa: E501
    ...
    def app_transforms_list(self, app_transforms_list):
        """Sets the app_transforms_list of this AppFilesOptionsModel.

        Gets or sets list of uploaded transform files.  # noqa: E501

        :param app_transforms_list: The app_transforms_list of this AppFilesOptionsModel.  # noqa: E501
    ...
    def app_patches_list(self):
        """Gets the app_patches_list of this AppFilesOptionsModel.  # noqa: E501

        Gets or sets list of uploaded patch files.  # noqa: E501

        :return: The app_patches_list of this AppFilesOptionsModel.  # noqa: E501
    ...
    def app_patches_list(self, app_patches_list):
        """Sets the app_patches_list of this AppFilesOptionsModel.

        Gets or sets list of uploaded patch files.  # noqa: E501

        :param app_patches_list: The app_patches_list of this AppFilesOptionsModel.  # noqa: E501
    ...
    def application_un_install_process(self):
        """Gets the application_un_install_process of this AppFilesOptionsModel.  # noqa: E501

        Gets or sets application uninstallation process.  # noqa: E501

        :return: The application_un_install_process of this AppFilesOptionsModel.  # noqa: E501
    ...
    def application_un_install_process(self, application_un_install_process):
        """Sets the application_un_install_process of this AppFilesOptionsModel.

        Gets or sets application uninstallation process.  # noqa: E501

        :param application_un_install_process: The application_un_install_process of this AppFilesOptionsModel.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AppFilesOptionsModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AppFilesOptionsModel):
            return False
