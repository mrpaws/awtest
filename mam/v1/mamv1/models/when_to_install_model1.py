...
class WhenToInstallModel1(object):
    ...
    def __init__(self, data_contingencies=None, disk_space_required_in_kb=None, device_power_required=None, ram_required_in_mb=None, _configuration=None):  # noqa: E501
        """WhenToInstallModel1 - a model defined in Swagger"""  # noqa: E501
    ...
    def data_contingencies(self):
        """Gets the data_contingencies of this WhenToInstallModel1.  # noqa: E501

        Gets or sets data Contingencies.  # noqa: E501

        :return: The data_contingencies of this WhenToInstallModel1.  # noqa: E501
    ...
    def data_contingencies(self, data_contingencies):
        """Sets the data_contingencies of this WhenToInstallModel1.

        Gets or sets data Contingencies.  # noqa: E501

        :param data_contingencies: The data_contingencies of this WhenToInstallModel1.  # noqa: E501
    ...
    def disk_space_required_in_kb(self):
        """Gets the disk_space_required_in_kb of this WhenToInstallModel1.  # noqa: E501

        Gets or sets the disk space required for installation of the package in KB.  # noqa: E501

        :return: The disk_space_required_in_kb of this WhenToInstallModel1.  # noqa: E501
        :rtype: int
        """
    ...
    def disk_space_required_in_kb(self, disk_space_required_in_kb):
        """Sets the disk_space_required_in_kb of this WhenToInstallModel1.

        Gets or sets the disk space required for installation of the package in KB.  # noqa: E501

        :param disk_space_required_in_kb: The disk_space_required_in_kb of this WhenToInstallModel1.  # noqa: E501
        :type: int
        """
    ...
    def device_power_required(self):
        """Gets the device_power_required of this WhenToInstallModel1.  # noqa: E501

        Gets or sets the device power required for installation of the package. Valid range 0 - 100.  # noqa: E501

        :return: The device_power_required of this WhenToInstallModel1.  # noqa: E501
        :rtype: int
        """
    ...
    def device_power_required(self, device_power_required):
        """Sets the device_power_required of this WhenToInstallModel1.

        Gets or sets the device power required for installation of the package. Valid range 0 - 100.  # noqa: E501

        :param device_power_required: The device_power_required of this WhenToInstallModel1.  # noqa: E501
        :type: int
        """
    ...
    def ram_required_in_mb(self):
        """Gets the ram_required_in_mb of this WhenToInstallModel1.  # noqa: E501

        Gets or sets the RAM required for the installation of the page in MB.  # noqa: E501

        :return: The ram_required_in_mb of this WhenToInstallModel1.  # noqa: E501
        :rtype: int
        """
    ...
    def ram_required_in_mb(self, ram_required_in_mb):
        """Sets the ram_required_in_mb of this WhenToInstallModel1.

        Gets or sets the RAM required for the installation of the page in MB.  # noqa: E501

        :param ram_required_in_mb: The ram_required_in_mb of this WhenToInstallModel1.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WhenToInstallModel1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WhenToInstallModel1):
            return False
