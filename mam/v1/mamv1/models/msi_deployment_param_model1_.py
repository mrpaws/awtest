...
class MsiDeploymentParamModel1_(object):
    ...
    def __init__(self, command_line_arguments=None, install_timeout_in_minutes=None, retry_count=None, retry_interval_in_minutes=None, install_context=None, _configuration=None):  # noqa: E501
        """MsiDeploymentParamModel1_ - a model defined in Swagger"""  # noqa: E501
    ...
    def command_line_arguments(self):
        """Gets the command_line_arguments of this MsiDeploymentParamModel1_.  # noqa: E501

        Gets or sets command-line options to be used when calling MSIEXEC.exe.  # noqa: E501

        :return: The command_line_arguments of this MsiDeploymentParamModel1_.  # noqa: E501
        :rtype: str
        """
    ...
    def command_line_arguments(self, command_line_arguments):
        """Sets the command_line_arguments of this MsiDeploymentParamModel1_.

        Gets or sets command-line options to be used when calling MSIEXEC.exe.  # noqa: E501

        :param command_line_arguments: The command_line_arguments of this MsiDeploymentParamModel1_.  # noqa: E501
        :type: str
        """
    ...
    def install_timeout_in_minutes(self):
        """Gets the install_timeout_in_minutes of this MsiDeploymentParamModel1_.  # noqa: E501
        ...
        :return: The install_timeout_in_minutes of this MsiDeploymentParamModel1_.  # noqa: E501
        :rtype: int
        """
    ...
    def install_timeout_in_minutes(self, install_timeout_in_minutes):
        """Sets the install_timeout_in_minutes of this MsiDeploymentParamModel1_.

        Gets or sets amount of time, in minutes that the installation process can run before the installer  considers the installation may have failed and no longer monitors the installation operation.Range 0-60.  # noqa: E501

        :param install_timeout_in_minutes: The install_timeout_in_minutes of this MsiDeploymentParamModel1_.  # noqa: E501
        :type: int
        """
    ...
    def retry_count(self):
        """Gets the retry_count of this MsiDeploymentParamModel1_.  # noqa: E501
        ...
        :return: The retry_count of this MsiDeploymentParamModel1_.  # noqa: E501
        :rtype: int
        """
    ...
    def retry_count(self, retry_count):
        """Sets the retry_count of this MsiDeploymentParamModel1_.

        Gets or sets the number of times the download and installation operation will be retried before the installation will be marked as failed. With a limit of ‘10' attempts.  # noqa: E501

        :param retry_count: The retry_count of this MsiDeploymentParamModel1_.  # noqa: E501
        :type: int
        """
    ...
    def retry_interval_in_minutes(self):
        """Gets the retry_interval_in_minutes of this MsiDeploymentParamModel1_.  # noqa: E501

        Gets or sets amount of time, in minutes between retry operations. Range 0-10.  # noqa: E501

        :return: The retry_interval_in_minutes of this MsiDeploymentParamModel1_.  # noqa: E501
        :rtype: int
        """
    ...
    def retry_interval_in_minutes(self, retry_interval_in_minutes):
        """Sets the retry_interval_in_minutes of this MsiDeploymentParamModel1_.

        Gets or sets amount of time, in minutes between retry operations. Range 0-10.  # noqa: E501

        :param retry_interval_in_minutes: The retry_interval_in_minutes of this MsiDeploymentParamModel1_.  # noqa: E501
        :type: int
        """
    ...
    def install_context(self):
        """Gets the install_context of this MsiDeploymentParamModel1_.  # noqa: E501

        Gets or sets the windows msi install context. Supported Values: Device = 1, User = 2.  # noqa: E501

        :return: The install_context of this MsiDeploymentParamModel1_.  # noqa: E501
        :rtype: int
        """
    ...
    def install_context(self, install_context):
        """Sets the install_context of this MsiDeploymentParamModel1_.

        Gets or sets the windows msi install context. Supported Values: Device = 1, User = 2.  # noqa: E501

        :param install_context: The install_context of this MsiDeploymentParamModel1_.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsiDeploymentParamModel1_, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsiDeploymentParamModel1_):
            return False
