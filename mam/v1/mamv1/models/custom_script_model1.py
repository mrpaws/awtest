...
class CustomScriptModel1(object):
    ...
    def __init__(self, custom_script_type=None, uninstall_command=None, uninstall_script_blob_id=None, _configuration=None):  # noqa: E501
        """CustomScriptModel1 - a model defined in Swagger"""  # noqa: E501
    ...
    def custom_script_type(self):
        """Gets the custom_script_type of this CustomScriptModel1.  # noqa: E501

        Gets or sets the custom script type (Supported values: Input = 1, Upload = 2).  # noqa: E501

        :return: The custom_script_type of this CustomScriptModel1.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_script_type(self, custom_script_type):
        """Sets the custom_script_type of this CustomScriptModel1.

        Gets or sets the custom script type (Supported values: Input = 1, Upload = 2).  # noqa: E501

        :param custom_script_type: The custom_script_type of this CustomScriptModel1.  # noqa: E501
        :type: str
        """
    ...
    def uninstall_command(self):
        """Gets the uninstall_command of this CustomScriptModel1.  # noqa: E501

        Gets or sets the application uninstall command provided.  # noqa: E501

        :return: The uninstall_command of this CustomScriptModel1.  # noqa: E501
        :rtype: str
        """
    ...
    def uninstall_command(self, uninstall_command):
        """Sets the uninstall_command of this CustomScriptModel1.

        Gets or sets the application uninstall command provided.  # noqa: E501

        :param uninstall_command: The uninstall_command of this CustomScriptModel1.  # noqa: E501
        :type: str
        """
    ...
    def uninstall_script_blob_id(self):
        """Gets the uninstall_script_blob_id of this CustomScriptModel1.  # noqa: E501
        ...
        :return: The uninstall_script_blob_id of this CustomScriptModel1.  # noqa: E501
        :rtype: int
        """
    ...
    def uninstall_script_blob_id(self, uninstall_script_blob_id):
        """Sets the uninstall_script_blob_id of this CustomScriptModel1.

        Gets or sets the ID value of the uninstall script file uploaded on the console.  Supported file types : js,jse,ps1,ps1xml,psc1,psd1,psm1,pssc,cdxml,vbs,vbe,wsf,wsc.  # noqa: E501

        :param uninstall_script_blob_id: The uninstall_script_blob_id of this CustomScriptModel1.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomScriptModel1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomScriptModel1):
            return False
