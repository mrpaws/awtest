...
class AppleOsXRestrictionAirPrintPayloadEntity(object):
    ...
    def __init__(self, allow_air_print=None, force_air_print_trusted_tls_requirement=None, allow_air_printi_beacon_discovery=None, _configuration=None):  # noqa: E501
        """AppleOsXRestrictionAirPrintPayloadEntity - a model defined in Swagger"""  # noqa: E501
    ...
    def allow_air_print(self):
        """Gets the allow_air_print of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501

        Gets or sets a value indicating whether if set to false, disallows AirPrint on macOS 10.13+.  # noqa: E501

        :return: The allow_air_print of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_air_print(self, allow_air_print):
        """Sets the allow_air_print of this AppleOsXRestrictionAirPrintPayloadEntity.

        Gets or sets a value indicating whether if set to false, disallows AirPrint on macOS 10.13+.  # noqa: E501

        :param allow_air_print: The allow_air_print of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501
        :type: bool
        """
    ...
    def force_air_print_trusted_tls_requirement(self):
        """Gets the force_air_print_trusted_tls_requirement of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501
        ...
        :return: The force_air_print_trusted_tls_requirement of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501
        :rtype: bool
        """
    ...
    def force_air_print_trusted_tls_requirement(self, force_air_print_trusted_tls_requirement):
        """Sets the force_air_print_trusted_tls_requirement of this AppleOsXRestrictionAirPrintPayloadEntity.

        Gets or sets a value indicating whether if set to true, requires trusted certificates for TLS printing communication on macOS 10.13+.  # noqa: E501

        :param force_air_print_trusted_tls_requirement: The force_air_print_trusted_tls_requirement of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501
        :type: bool
        """
    ...
    def allow_air_printi_beacon_discovery(self):
        """Gets the allow_air_printi_beacon_discovery of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501
        ...
        :return: The allow_air_printi_beacon_discovery of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_air_printi_beacon_discovery(self, allow_air_printi_beacon_discovery):
        """Sets the allow_air_printi_beacon_discovery of this AppleOsXRestrictionAirPrintPayloadEntity.

        Gets or sets a value indicating whether if set to false, disables iBeacon discovery of AirPrint printers on macOS 10.13+.  # noqa: E501

        :param allow_air_printi_beacon_discovery: The allow_air_printi_beacon_discovery of this AppleOsXRestrictionAirPrintPayloadEntity.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AppleOsXRestrictionAirPrintPayloadEntity, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AppleOsXRestrictionAirPrintPayloadEntity):
            return False
